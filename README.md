This repo contains a comprehensive introduction to information theory for social scientists and other people who do not necessarily have a mathematical background, with a particular emphasis on the role of information theory in language modelling. Moreover, the material also connects these mathematical concepts to relevant interpretations and extensions of them in the social sciences. The material is best accessed through the Quarto rendered tutorial at [mikaelbrunila.com/information-theory/](https://mikaelbrunila.com/information-theory/), but can also be used by cloning the repo and using the notebooks locally. 
